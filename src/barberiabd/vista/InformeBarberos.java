...
public class InformeBarberos extends javax.swing.JFrame {
    ...
    public InformeBarberos() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select nombre, id, telefono, maquinaAsignada, porcentajeComision from barbero");

            ResultSet rs = pst.executeQuery();
            Tabla_Barberos = new JTable(model);
            jScrollPane1.setViewportView(Tabla_Barberos);
            model.addColumn("Nombre");
            model.addColumn("Identificación");
            model.addColumn("Telefono");
            model.addColumn("Maquina asignada");
            model.addColumn("Porcentaje comisión");
    ...
    private void initComponents() {
        ...
        Tabla_Barberos = new javax.swing.JTable();
        ...
        Tabla_Barberos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 550, 130));
        ...
        getContentPane().add(regresar_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, -1, -1));

        jLabel1.setFont(new java.awt.Font("Leelawadee", 0, 14)); // NOI18N
        jLabel1.setText("Lista de barberos:");
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 80, 70));
    ...
    private javax.swing.JTable Tabla_Barberos;
